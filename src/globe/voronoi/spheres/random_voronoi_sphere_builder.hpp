#ifndef GLOBEART_SRC_GLOBE_VORONOI_SPHERE_RANDOM_VORONOI_SPHERE_BUILDER_HPP_
#define GLOBEART_SRC_GLOBE_VORONOI_SPHERE_RANDOM_VORONOI_SPHERE_BUILDER_HPP_
...
#endif //GLOBEART_SRC_GLOBE_VORONOI_SPHERE_RANDOM_VORONOI_SPHERE_BUILDER_HPP_
