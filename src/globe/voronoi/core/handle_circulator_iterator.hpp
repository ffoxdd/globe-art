#ifndef GLOBEART_SRC_GLOBE_VORONOI_CORE_HANDLE_CIRCULATOR_ITERATOR_HPP_
#define GLOBEART_SRC_GLOBE_VORONOI_CORE_HANDLE_CIRCULATOR_ITERATOR_HPP_
...
#endif //GLOBEART_SRC_GLOBE_VORONOI_CORE_HANDLE_CIRCULATOR_ITERATOR_HPP_
